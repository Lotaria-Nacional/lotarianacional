...
export type AddUserRequest = Omit<UserEntity,"id" | "createdAt" | "profilePic"> & {password:string, profilePic:File | null}
...
export async function updateUser({ data, id }: UpdateUserRequest): Promise<APIResponseMessage> {
