...
export async function addNews (data:CreateNewsRequest):Promise<APIResponseMessage>{
    const response = await axios.post("/news", data.data)
    return response.data
}


export async function getAllNews ({ page }:PaginationParams):Promise<GetAllNewsResponse>{
...
export async function updateNews (data:UpdateNewsRequest):Promise<APIResponseMessage>{
    console.log(data)   
