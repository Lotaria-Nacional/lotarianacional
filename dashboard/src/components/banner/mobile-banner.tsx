...
const MobileBanner = () => {
  ...
  const [mobileTopBanners, setMobileTopBanners] = useState({
    banner1: "",
    banner2: "",
    banner3: "",
  })
  const [prevMobileTopBanners, setPrevMobileTopBanners] = useState({
    banner1: "",
    banner2: "",
    banner3: "",
  })
  ...
  const handleImage = async (
    ...
    if (value) {
      ...
      setPrevMobileTopBanners({
        ...prevMobileTopBanners,
        [key]: urlPreview,
      })
      setMobileTopBanners({
        ...mobileTopBanners,
      ...
      <Accordion type="single" collapsible>
        ...
        >
          ...
          <AccordionContent className="flex items-center gap-4">
            <img
              alt=""
              src={prevMobileTopBanners.banner1}
        ...
        >
          ...
          <AccordionContent className="flex items-center gap-4">
            <img
              alt=""
              src={prevMobileTopBanners.banner2}
              className="w-[300px] h-[250px] object-contain"
            />
            <div className="flex flex-col items-center gap-2">
              <input
        ...
        >
          ...
          <AccordionContent className="flex items-center gap-4">
            <img
              alt=""
              src={prevMobileTopBanners.banner3}
              className="w-[300px] h-[250px] object-contain"
            />
            <div className="flex flex-col items-center gap-2">
              <input
