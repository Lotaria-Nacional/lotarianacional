...
export const router = createBrowserRouter([
...

  {
    ...
    children: [
      ...
      //Legal
      { path: 'itermos-e-condicoes-gerais', element: <TermsPage /> },
      { path: 'itermos-de-privacidade', element: <PoliticsAndPrivacyPage /> },
      { path: 'iregulamentos-do-loto-5-90', element: <RegulamentationPage /> },
    ],
  },
]);
