          ...
          <div className="flex w-full flex-col md:flex-row items-center md:items-start gap-4">
            ...
            <div className="flex flex-col gap-2 items-center md:items-start ">
              ...
              <p>
                ...
                Valorizamos a confiança que os nossos jogadores depositam em nós
                e trabalhamos com rigor para garantir que todas as operações são
                realizadas de forma justa e segura.
              </p>
              <ul className="flex flex-col gap-4">
                <li>
                  ...
                  Encorajamos o jogo responsável e disponibilizamos ferramentas
                  para ajudar os jogadores a controlar os seus hábitos de jogo.
                  Promovemos a conscientização sobre os riscos do jogo excessivo
                  e oferecemos suporte a quem necessitar.
                </li>

                <li>
                  <p>
                    <span className="font-bold mr-1">Proteção ao Jogador:</span>
                    Respeitamos a privacidade e os dados pessoais dos nossos
                    jogadores, através de medidas rigorosas que protegem todas
                    as informações coletadas. Além disso, asseguramos que apenas
                    pessoas maiores de idade podem participar dos nossos jogos.
                  </p>
                </li>
                ...
                <li>
                  <p>
                    ...
                    sorteios. As nossas máquinas e algoritmos são regularmente
            ...
            <div className="flex flex-col gap-2 md:items-start items-center">
              ...
              <ul className="flex flex-col gap-4">
                <li className="flex flex-col">
                  ...
                  <p>Honestidade e transparência em todas as nossas ações.</p>
                </li>
                <li className="flex flex-col">
                ...
                <li className="flex flex-col">
                  ...
                  <p>Não é caro, grande rede de vendedores. Fácil de jogar.</p>
                </li>
                <li className="flex flex-col">
