...
const PlayGroundTable = () => {
  ...
  return (
    <main className="w-full flex flex-col items-center min-h-[303px] gap-4 lg:gap-[40px]">
      <div className="w-full flex lg:flex-row flex-col gap-4 lg:h-[42px] items-center justify-between">
        <div className="flex lg:h-full items-center h-[33px] rounded-[10px] w-full lg:w-[457px]">
          <span className="bg-white h-full flex font-semibold text-[12px] lg:text-[16px] rounded-l-[10px] px-[16px] w-full items-center justify-center text-center">
        ...
        <input
          ...
          className="w-[340px] bg-white py-[10px] rounded-[10px] text-[16px] h-full border-none outline-none text-center placeholder:text-center placeholder:text-[#818181]"
        />
      </div>
