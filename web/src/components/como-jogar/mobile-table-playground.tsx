import { tableHeadersMobile } from "@/constants/teste"
import { TablePlayroundProps } from "./desktop-table-playground"

import TableInfoMobile from "./table-info-mobile"

const MobileTablePlayground = ({
  value,
  formatMoney,
  filterTableContent,
}: TablePlayroundProps) => {
...
export default MobileTablePlayground
