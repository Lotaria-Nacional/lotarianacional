...
export const buttonVariants = cva(
    [
      ...
      "disabled:opacity-70 ease-in-out duration-200 transition-all hover:opacity-75",
    ],
    {
      variants: {
        intent: {
          ...
          secondary: "bg-transparent border hover:opacity-70 border-LT_RED-300 text-LT_RED-300",
